    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(blank=True, default=0, related_name='posts_likes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='net.post')),
